#' Organize Stan output and provide summaries of model parameters for longitudinal models
#' 
...
#' @param quiet If TRUE, then results aren't printed.
#' @return A STRAND results object including summary table, a summary list, and samples.
#' @export
#' @examples
#' \dontrun{
#' res = summarize_longitudinal_bsrm_results(input = fit)
#' }
#'

summarize_longitudinal_bsrm_results = function(input, include_samples=TRUE, HPDI=0.9, quiet=FALSE){
