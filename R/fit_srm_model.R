...
#' 
#' This function allows a user to supply emprical or simulated data, and analyse it using a Bayesian Social Relations Model in Stan. The user must supply a STRAND data object,
