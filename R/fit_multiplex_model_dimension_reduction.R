...
fit_multiplex_model_dimension_reduction = function(data,
                               block_regression,
                               focal_regression,
                               target_regression,
                               dyad_regression,
    ...
    if(attributes(data)$class != "STRAND Data Object"){
        stop("fit_multiplex_model_dimension_reduction() requires a data object of class: STRAND Data Object. Please use make_strand_data() to build your data list.")
    }
