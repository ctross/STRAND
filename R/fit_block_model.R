#' A function to run STRAND block models
#' 
#' This function allows a user to supply emprical or simulated data, and analyse it using a Bayesian block model in Stan. The user must supply a STRAND data object,
