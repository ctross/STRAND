#' A function to run a combined stochastic block and social relations model using the STRAND framework
#' 
#' This function allows a user to supply empirical or simulated data, and analyse it using a Bayesian stochastic block and social relations model in Stan. The user must supply a STRAND data object,
