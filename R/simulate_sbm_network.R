...
#' B[1,1] = 0.07
#' 
#' A = simulate_sbm_network(N_id = 100, B=B, individual_predictor=matrix(rnorm(100, 0, 1), nrow=100,ncol=1), individual_effects=matrix(c(1.2, 0.5),ncol=1,nrow=2))
...
simulate_sbm_network = function(N_id = 90,                        # Number of respondents
                                ...
                                sr_rho = 0.3,                     # Correlation of sender and reciever effects
